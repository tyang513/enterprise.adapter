	...
	modules : [
			{
				name : 'zf/bootloader',
				create : true,
				include : [ "jquery", "easyuiplugins/jquery.parser",
...
//	},
	...
	shim : {
		...
		"easyuiplugins/jquery.menubutton" : [ "jquery",
				"easyuiplugins/jquery.menu", "easyuiplugins/jquery.linkbutton" ],
		...
		"easyuiplugins/jquery.combotree" : [ "jquery",
				"easyuiplugins/jquery.combo", "easyuiplugins/jquery.tree" ],
		...
		// Window
		"easyuiplugins/jquery.window" : [ "easyuiplugins/jquery.draggable",
				"easyuiplugins/jquery.resizable",
				"easyuiplugins/jquery.panel.custom" ],
		"easyuiplugins/jquery.dialog" : [ "easyuiplugins/jquery.window",
				"easyuiplugins/jquery.linkbutton" ],
		"easyuiplugins/jquery.messager" : [ "easyuiplugins/jquery.window",
				"easyuiplugins/jquery.linkbutton",
		...
		"easyuiplugins/jquery.datagrid.custom" : [ "jquery",
				...
				"easyuiplugins/jquery.resizable",
				"easyuiplugins/jquery.linkbutton",
				"easyuiplugins/jquery.pagination.custom" ],
		...
		"easyuilocale/easyui-lang-zh_CN" : [
				...
				"easyuiplugins/jquery.dialog", "easyuiplugins/jquery.messager",
				"easyuiplugins/jquery.datagrid.custom",
