define([ "text!./templates/pieList.html", "app/base/BaseContentList", "app/sentiment/sentimentconfig/searchbar/templateSearchBar","text!app/sentiment/sentimentconfig/config/templateService.json" ], function(template, BaseContentList, searchBar, serviceConf) {
	app.serviceLocator.mergeConfig(serviceConf);
	return $.widget("app.pieList", BaseContentList, {
		// default options
		options : {
			entity : 'template',
			entityName : '模板',
