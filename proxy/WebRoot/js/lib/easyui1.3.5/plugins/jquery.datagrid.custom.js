...
(function($) {
	...
	function _1e(_1f) {
		...
		if (_20.height != "auto") {
			var _2c = _23 - _26.children("div.datagrid-header")._outerHeight() - _26.children("div.datagrid-footer")._outerHeight()
	...
	function _f8(_10e, _10f, _110) {
		...
		var rd = tr.find("div.datagrid-cell-check input[type=radio]");
		rd._propAttr("checked", true);
	...
	$.fn.datagrid.parseOptions = function(_1e6) {
		var t = $(_1e6);
		return $.extend({}, $.fn.panel.parseOptions(_1e6), $.parser.parseOptions(_1e6, [ "url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition",
				"resizeHandle", {
					fitColumns : "boolean",
				...
				if (col) {
					...
					if (col.checkbox) {
						if(opts.singleSelect == false){
							...
							if(col.radiobox){
								cc.push("<input type=\"radio\" name=\"" + _1ff + "\" value=\"" + (_200 != undefined ? _200 : "") + "\">");
							}else{
								cc.push("<input type=\"checkbox\" name=\"" + _1ff + "\" value=\"" + (_200 != undefined ? _200 : "") + "\">");
							}
						}
...
//						if (col.formatter) {
						if (col.formatter && _.isFunction(col.formatter)) {
