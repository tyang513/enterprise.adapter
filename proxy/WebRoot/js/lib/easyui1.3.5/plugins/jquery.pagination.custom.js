...
(function($) {
	...
	function _14(_15, _16) {
		...
		if (!_18.navigator && _18.pageNumber > _19) {
			_18.pageNumber = _19;
		}
		if (bb.num) {
	...
	$.fn.pagination.defaults = {
		...
		onBeforeNavigate : function(pageNumber, pageSize, navigator) {
		},
		onNavigate : function(pageNumber, pageSize, navigator) {
		},
		...
		nav : {
			first : {
				...
				handler : function() {
					...
					var _17 = $.data(this, "pagination");
					var _18 = _17.options;
					var bb = _17.bb;
					var disabled = (bb.first.parent().find('.l-btn-disabled').length == 1);
					if (_30.pageNumber > 1 || (_30.navigator && !disabled)) {
						if (_30.onBeforeNavigate.call(this, _30.pageNumber, _30.pageSize, 'first') != false) {
							$(this).pagination("select", 1);
							_30.onNavigate.call(this, _30.pageNumber, _30.pageSize, 'first');
						}
					}
				}
			},
			prev : {
				...
				handler : function() {
					...
					var _18 = _17.options;
					var bb = _17.bb;
					var disabled = (bb.prev.parent().find('.l-btn-disabled').length == 1);
					if (_31.pageNumber > 1 || (_31.navigator && !disabled)) {
						if (_31.onBeforeNavigate.call(this, _31.pageNumber, _31.pageSize, 'prev') != false) {
							$(this).pagination("select", _31.pageNumber - 1);
							_31.onNavigate.call(this, _31.pageNumber, _31.pageSize, 'prev');
						}
					}
				}
			},
			next : {
				...
				handler : function() {
					...
					var _18 = _17.options;
					var bb = _17.bb;
					var disabled = (bb.next.parent().find('.l-btn-disabled').length == 1);
					var _33 = Math.ceil(_32.total / _32.pageSize);
					if (_32.pageNumber < _33 || (_32.navigator && !disabled)) {
						if (_32.onBeforeNavigate.call(this, _32.pageNumber, _32.pageSize, 'next') != false) {
							$(this).pagination("select", _32.pageNumber + 1);
							_32.onNavigate.call(this, _32.pageNumber, _32.pageSize, 'next');
						}
					}
				}
			},
			last : {
				...
				handler : function() {
					...
					var _18 = _17.options;
					var bb = _17.bb;
					var disabled = (bb.last.parent().find('.l-btn-disabled').length == 1);
					var _35 = Math.ceil(_34.total / _34.pageSize);
					if (_34.pageNumber < _35 || (_34.navigator && !disabled)) {
						if (_34.onBeforeNavigate.call(this, _34.pageNumber, _34.pageSize, 'last') != false) {
							$(this).pagination("select", _35);
							_34.onNavigate.call(this, _34.pageNumber, _34.pageSize, 'last');
						}
					}
				}
			},
			refresh : {
				...
				handler : function() {
					...
					if (_36.onBeforeRefresh.call(this, _36.pageNumber, _36.pageSize) != false) {
						if (_36.onBeforeNavigate.call(this, _36.pageNumber, _36.pageSize, 'refresh') != false) {
							$(this).pagination("select", _36.pageNumber);
							_36.onNavigate.call(this, _36.pageNumber, _36.pageSize, 'refresh');
						}
