...
(function($) {
	...
	function _13(_14) {
		...
		// ------- custom begin -----
		if (_15.title && !_15.noheader && _15.custom) {
			if (_15.custom) {

				var _17 = $(
						"<div class=\"panel-header custom-panel-header\"><div class=\"panel-title custom-panel-title\"><span>" + _15.title
								+ "</span><div class=\"custom-line\"></div></div>").prependTo(_16);
				if (_15.iconCls) {
					_17.find(".panel-title").addClass("panel-with-icon");
					$("<div class=\"panel-icon\"></div>").addClass(_15.iconCls).appendTo(_17);
				}
				var _18 = $("<div class=\"panel-tool custom-panel-tool\"></div>").appendTo(_17);
				...
				_16.children("div.panel-body").addClass("custom-panel");

			}
		}
		// ------- custom end -----
		else if (_15.title && !_15.noheader) {
